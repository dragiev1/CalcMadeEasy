...
public class SectionServiceTest {
  // TODO: NEEDS TO BE FULLY TESTED ONCE HIERARCHY IS SET UP PROPERLY WITH JPA
  // STARTING FROM COURSE -> CHAPTER -> SECTION -> PAGE
  @Autowired
  ...
  public void setup() {
    ...
    chapter1 = Chapter.builder()
        .description("chapter description (test)")
  ...
  public void testRemovePage() {
    sectionService.createSection(section2);
    sectionService.removePage(section2.getId(), page1.getId());
